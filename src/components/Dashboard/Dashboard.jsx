      ...
      <div className="pt-20 pb-2 px-4 md:px-6 lg:px-8 max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-100 p-3 sm:p-4">
          <div className="flex flex-col space-y-4 lg:flex-row lg:items-center lg:justify-between lg:space-y-0">
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div className="min-w-0 flex-1">
                <h1 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 leading-tight">
                  <span className="text-gray-900">{getGreeting()}, {getFirstName()}! 👋</span>
                </h1>
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-3">
              <button className="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 md:px-4 py-2 bg-white text-gray-700 rounded-lg hover:bg-gray-50 transition-all duration-300 shadow-md hover:shadow-lg text-xs sm:text-sm font-medium border border-gray-200">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
            {quickStats.map((stat, index) => (
              <div
                key={index}
                className="bg-white rounded-xl shadow-md p-3 sm:p-4 border border-gray-100 hover:shadow-lg transition-all duration-300"
              >
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="font-medium text-gray-700 text-xs truncate">{stat.title}</h3>
                    <p className="text-base sm:text-lg font-bold text-gray-900 mt-1 truncate">{stat.value}</p>
          ...
          <div className="xl:col-span-2 space-y-4 sm:space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-100 p-3 sm:p-4">
              <div className="flex items-center mb-3 sm:mb-4">
                ...
                <h2 className="text-base sm:text-lg font-bold text-gray-900">Quick Admin Actions</h2>
              </div>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                <button className="flex flex-col items-center p-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-200 hover:bg-blue-100 transition-all duration-300 hover:scale-[1.02] cursor-pointer group">
                  ...
                  <span className="font-medium text-blue-900 text-sm text-center">Add Employee</span>
                </button>
                
                <button className="flex flex-col items-center p-4 bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl border border-green-200 hover:bg-green-100 transition-all duration-300 hover:scale-[1.02] cursor-pointer group">
                  ...
                  <span className="font-medium text-green-900 text-sm text-center">Review Requests</span>
                </button>
                
                <button className="flex flex-col items-center p-4 bg-gradient-to-br from-purple-50 to-violet-50 rounded-xl border border-purple-200 hover:bg-purple-100 transition-all duration-300 hover:scale-[1.02] cursor-pointer group">
                  ...
                  <span className="font-medium text-purple-900 text-sm text-center">CCTV Settings</span>
                </button>
                ...
                <button className="flex flex-col items-center p-4 bg-gradient-to-br from-indigo-50 to-blue-50 rounded-xl border border-indigo-200 hover:bg-indigo-100 transition-all duration-300 hover:scale-[1.02] cursor-pointer group">
                  ...
                  <span className="font-medium text-indigo-900 text-sm text-center">System Health</span>
                </button>
                
                <button className="flex flex-col items-center p-4 bg-gradient-to-br from-gray-50 to-slate-50 rounded-xl border border-gray-200 hover:bg-gray-100 transition-all duration-300 hover:scale-[1.02] cursor-pointer group">
                  ...
                  <span className="font-medium text-gray-900 text-sm text-center">Settings</span>
                </button>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-100 p-3 sm:p-4">
              <div className="flex items-center mb-3 sm:mb-4">
                ...
                <h2 className="text-base sm:text-lg font-bold text-gray-900">Coming Soon</h2>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                {upcomingFeatures.map((feature, index) => (
                  <div
                    key={index}
                    className="relative overflow-hidden bg-gradient-to-br from-gray-50 to-white rounded-xl p-4 sm:p-6 border border-gray-200 hover:shadow-md transition-all duration-300 hover:scale-[1.02] cursor-pointer group"
                  >
                    ...
                    <p className="text-xs sm:text-sm text-gray-600 mb-3 sm:mb-4 leading-relaxed">{feature.description}</p>
            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-100 p-3 sm:p-4">
              <div className="flex items-center justify-between mb-3 sm:mb-4">
                ...
                <button className="text-orange-600 hover:text-orange-700 text-xs sm:text-sm font-medium flex items-center hover:translate-x-1 transition-transform duration-300">
              ...
              <div className="space-y-3 sm:space-y-4">
                {dashboardData.employeePortal.recentRequests.map((request, index) => (
                  <div
                    key={index}
                    className="flex flex-col sm:flex-row sm:items-center justify-between p-3 sm:p-4 lg:p-5 bg-gray-50 rounded-xl hover:bg-gray-100 transition-all duration-200 hover:scale-[1.01] cursor-pointer group space-y-2 sm:space-y-0"
                  >
                    <div className="flex items-center space-x-3 sm:space-x-4">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 bg-orange-100 rounded-lg flex items-center justify-center group-hover:scale-[1.05] transition-transform duration-300 flex-shrink-0">
                        <span className="text-orange-600 font-semibold text-xs sm:text-sm">
                          {request.id.replace('#', '')}
                        </span>
                      </div>
                      <div className="min-w-0 flex-1">
                        <p className="font-medium text-gray-900 mb-1 text-sm sm:text-base truncate">{request.type}</p>
                        <p className="text-xs sm:text-sm text-gray-600">{request.amount} • {request.employee}</p>
            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-100 p-3 sm:p-4">
              <div className="flex items-center justify-between mb-3 sm:mb-4">
                <div className="flex items-center">
                  ...
                  <h2 className="text-base sm:text-lg font-bold text-gray-900">Employee Management</h2>
                </div>
                <button className="text-blue-600 hover:text-blue-700 text-xs sm:text-sm font-medium flex items-center hover:translate-x-1 transition-transform duration-300">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                <div className="bg-blue-50 rounded-xl p-3 sm:p-4 text-center">
                  <div className="text-2xl sm:text-3xl font-bold text-blue-600 mb-1">{dashboardData.employeeStats.totalEmployees}</div>
                  <div className="text-xs sm:text-sm text-blue-700 font-medium">Total Employees</div>
                </div>
                <div className="bg-green-50 rounded-xl p-3 sm:p-4 text-center">
                  <div className="text-2xl sm:text-3xl font-bold text-green-600 mb-1">{dashboardData.employeeStats.activeToday}</div>
                  <div className="text-xs sm:text-sm text-green-700 font-medium">Active Today</div>
                </div>
                <div className="bg-orange-50 rounded-xl p-3 sm:p-4 text-center">
                  <div className="text-2xl sm:text-3xl font-bold text-orange-600 mb-1">{dashboardData.employeeStats.onLeave}</div>
                  <div className="text-xs sm:text-sm text-orange-700 font-medium">On Leave</div>
                </div>
                <div className="bg-purple-50 rounded-xl p-3 sm:p-4 text-center">
                  <div className="text-2xl sm:text-3xl font-bold text-purple-600 mb-1">{dashboardData.employeeStats.departments}</div>
                  <div className="text-xs sm:text-sm text-purple-700 font-medium">Departments</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-100 p-3 sm:p-4">
              <div className="flex items-center mb-3 sm:mb-4">
                ...
                <h2 className="text-base sm:text-lg font-bold text-gray-900">System Overview</h2>
              </div>
              
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-center justify-between p-3 sm:p-4 bg-orange-50 rounded-xl hover:bg-orange-100 transition-all duration-300 hover:scale-[1.01] cursor-pointer group">
                  <div className="flex items-center space-x-2 sm:space-x-3">
                    ...
                    <span className="font-medium text-gray-900 text-sm sm:text-base">Employee Portal</span>
                  </div>
                  <span className="text-xs sm:text-sm text-orange-600 font-medium px-2 sm:px-3 py-1 bg-orange-100 rounded-full">Active</span>
                </div>
                
                <div className="flex items-center justify-between p-3 sm:p-4 bg-purple-50 rounded-xl hover:bg-purple-100 transition-all duration-300 hover:scale-[1.01] cursor-pointer group">
                  <div className="flex items-center space-x-2 sm:space-x-3">
                    <Eye className="w-4 h-4 sm:w-5 sm:h-5 text-purple-600 group-hover:scale-[1.05] transition-transform duration-300" />
                    <span className="font-medium text-gray-900 text-sm sm:text-base">CCTV System</span>
                  </div>
                  <span className="text-xs sm:text-sm text-purple-600 font-medium px-2 sm:px-3 py-1 bg-purple-100 rounded-full">Monitoring</span>
                </div>

                <div className="flex items-center justify-between p-3 sm:p-4 bg-blue-50 rounded-xl hover:bg-blue-100 transition-all duration-300 hover:scale-[1.01] cursor-pointer group">
                  <div className="flex items-center space-x-2 sm:space-x-3">
                  ...
                  <span className="text-xs sm:text-sm text-blue-600 font-medium px-2 sm:px-3 py-1 bg-blue-100 rounded-full">{dashboardData.systemMetrics.databaseHealth}</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-100 p-3 sm:p-4">
              <div className="flex items-center mb-3 sm:mb-4">
                ...
                <h2 className="text-base sm:text-lg font-bold text-gray-900">System Metrics</h2>
              </div>
              
              <div className="space-y-3 sm:space-y-4">
                <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl p-3 sm:p-4">
                  <div className="text-center">
                    <div className="text-2xl sm:text-3xl font-bold text-indigo-600 mb-1">{dashboardData.systemMetrics.performanceScore}%</div>
                    <div className="text-xs sm:text-sm text-indigo-700 font-medium">Performance Score</div>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-semibold text-green-600">{dashboardData.systemMetrics.serverUptime}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-600">Last Backup:</span>
                    <span className="font-semibold text-gray-900">{dashboardData.systemMetrics.backupStatus.split(': ')[1]}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-100 p-3 sm:p-4">
              <div className="flex items-center mb-3 sm:mb-4">
                ...
                <h2 className="text-base sm:text-lg font-bold text-gray-900">Admin Alerts</h2>
              </div>
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-center justify-between p-3 bg-red-50 rounded-xl border border-red-200">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm font-medium text-red-900">Security Alert</span>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-xl border border-yellow-200">
                  ...
                  <span className="text-xs text-yellow-600 font-medium">12 requests</span>
                </div>
                
                <div className="flex items-center justify-between p-3 bg-blue-50 rounded-xl border border-blue-200">
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                    <span className="text-sm font-medium text-blue-900">System Update</span>
                  </div>
            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-100 p-3 sm:p-4">
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-3 sm:p-4">
                  <div className="text-center">
                    <div className="text-2xl sm:text-3xl font-bold text-green-600 mb-1">{dashboardData.financialOverview.remainingBudget}</div>
                    <div className="text-xs sm:text-sm text-green-700 font-medium">Remaining Budget</div>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-semibold text-gray-900">{dashboardData.financialOverview.monthlyBudget}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-600">Spent This Month:</span>
                    <span className="font-semibold text-orange-600">{dashboardData.financialOverview.spentThisMonth}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-600">Top Category:</span>
                    <span className="font-semibold text-gray-900">{dashboardData.financialOverview.topExpenseCategory}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-100 p-3 sm:p-4">
              <div className="flex items-center mb-3 sm:mb-4">
                ...
                <h2 className="text-base sm:text-lg font-bold text-gray-900">Security Status</h2>
              </div>
              
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-center justify-between hover:bg-gray-50 p-2 sm:p-3 rounded-lg transition-colors duration-300">
                  <span className="text-gray-600 font-medium text-sm sm:text-base">Active Cameras</span>
                ...
                <div className="flex items-center justify-between hover:bg-gray-50 p-2 sm:p-3 rounded-lg transition-colors duration-300">
                  <span className="text-gray-600 font-medium text-sm sm:text-base">Security Alerts</span>
                ...
                <div className="flex items-center justify-between hover:bg-gray-50 p-2 sm:p-3 rounded-lg transition-colors duration-300">
                  <span className="text-gray-600 font-medium text-sm sm:text-base">System Status</span>
                  <div className="flex items-center space-x-2">
